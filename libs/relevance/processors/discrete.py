        ...
        if not relevance:
            ...
            if ratio > 1:
                if   self.is_multiple_of(ratio, 10, 0.5):
                    relevance = Relevance(8, Relevance.RELEVANCE_TYPE_PERCENTAGE, ratio)
                elif self.is_multiple_of(ratio, 5, 0.5):
                    relevance = Relevance(7, Relevance.RELEVANCE_TYPE_PERCENTAGE, ratio)
                elif self.is_multiple_of(ratio, 1, 0.01):
                    relevance = Relevance(6, Relevance.RELEVANCE_TYPE_PERCENTAGE, ratio)
