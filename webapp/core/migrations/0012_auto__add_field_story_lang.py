...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Story.lang'
        db.add_column(u'core_story', 'lang',
                      self.gf('django.db.models.fields.CharField')(default='en_GB', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Story.lang'
        db.delete_column(u'core_story', 'lang')
    ...
    models = {
        ...
        u'core.story': {
            ...
            'lang': ('django.db.models.fields.CharField', [], {'default': "'en_GB'", 'max_length': '5'}),
        ...
        u'currency.currency': {
            'Meta': {'ordering': "['priority', 'name']", 'object_name': 'Currency'},
